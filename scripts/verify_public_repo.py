...
def _render_readme(summary: dict[str, object]) -> str:
    ...
    lines = [
        ...
        "",
        f"This repository publishes public proof artifacts for the current public carrier, {summary['public_carrier']}. It is designed to prove process discipline: prospective hash publication, append-only handling, delayed aggregate reporting, correction lineage, and verification rules.",
        "",
        ...
        "## Current Status",
        "",
        f"- Public carrier: {summary['public_carrier']}.",
...
def _render_current_carrier(summary: dict[str, object]) -> str:
    ...
    lines = [
        ...
        "",
        f"Carrier: {summary['public_carrier']}",
        "",
